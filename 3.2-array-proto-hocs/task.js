...
//Вывод: обычная функция выполнялась 25097.079ms в то время как улучшенная функция (с сохранением памяти) выполнялась всего 1526.454ms.
//Если убрать задержку из обычной функции, то она выполняется быстрее (0.073ms) чем функция с памятью (10.896ms)
